...
exports.verifyAuth = (0, handle_async_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    let token;
    ...
    if (!token)
        return next(new error_handler_1.GlobalError("You are not logged in. Please login to get access", 401));
    try {
        ...
        return next(new error_handler_1.GlobalError("Session expired. Please log in again", 401));
    }
    next();
}));
